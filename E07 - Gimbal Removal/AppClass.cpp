...
void Application::Display(void)
{
	...
	*/
	...
	quaternion xAngle = glm::angleAxis(glm::radians(m_v3Rotation.x), vector3(1.0f, 0.0f, 0.0f));
	quaternion yAngle = glm::angleAxis(glm::radians(m_v3Rotation.y), vector3(0.0f, 1.0f, 0.0f));
	quaternion zAngle = glm::angleAxis(glm::radians(m_v3Rotation.z), vector3(0.0f, 0.0f, 1.0f));

	m_qOrientation = m_qOrientation * xAngle * yAngle * zAngle;
